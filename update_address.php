...
if(isset($_POST['submit'])){
   ...
   $update_address = $conn->prepare("UPDATE `users` SET address = :address WHERE id = :user_id");
   $update_address->bindParam(':address', $address, PDO::PARAM_STR);
   $update_address->bindParam(':user_id', $user_id, PDO::PARAM_INT);
